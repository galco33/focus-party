/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.cloudflare.jsonc` (hash: bf98ec5a25f34912df52933a16d04c3a)
// Runtime types generated with workerd@1.20260515.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	...
	REALTIME: DurableObjectNamespace<import("./dist/server/index").RealtimeRoom>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "TWITCH_EVENTSUB_SECRET" | "TWITCH_TOKEN_ENCRYPTION_KEY">> {}
}
